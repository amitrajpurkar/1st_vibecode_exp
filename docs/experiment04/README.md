...
This is a question bank application. <span style="background-color:yellow">practise with different tech stack</span>


## github repo
https://github.com/amitrajpurkar/q_and_a_practise1

```bash
git clone git@github.com:amitrajpurkar/q_and_a_practise1.git
...
make use of spec-kit to trial or <span style="background-color:yellow">experiment-different-tech-stacks</span>
